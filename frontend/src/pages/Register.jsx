      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
          <div className="max-w-md">
            <h1 className="text-5xl font-bold mb-6">Join EventDesk Today!</h1>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-100">Get started in under 5 minutes</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-100">Integrated Stripe & PayPal processing</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-semibold">Complete Tools</h3>
                  <p className="text-sm text-purple-100">Everything you need to manage events</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-100">Track performance and grow your events</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-900">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-gray-400">Join thousands of event organizers today.</p>
          </div>
