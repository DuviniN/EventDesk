          ...
          <div className="max-w-md">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-white">Manage Events</h3>
                  <p className="text-sm text-white/80">Create and organize events effortlessly</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-white/15 rounded-lg flex items-center justify-center shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Monitor sales and attendance in real-time</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-white/15 rounded-lg flex items-center justify-center shadow-sm">
                ...
                <div>
                  <h3 className="font-semibold text-white">Automated Emails</h3>
                  <p className="text-sm text-white/80">Keep attendees informed automatically</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#6a317f] mb-2">Sign In</h2>
            <p className="text-[#6a317f]">Welcome back! Please enter your details.</p>
          </div>
